...
export const Timer = ({ time }: TimerProps) => {
    ...
    return (
        <div className={"flex justify-center h-full items-center text-blue  transition-all w-full font-normal text-6xl card:text-9xl md:text-9xl font-lexend"}>
            ...
            <div className="!md:w-7">{divider}</div>
